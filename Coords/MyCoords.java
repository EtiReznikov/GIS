...
public class MyCoords implements coords_converter{
	...
	public static void main(String[] args) {
		...
		//System.out.println(test.vector3D(p0, p1));
	
		System.out.println();


		//System.out.println(p1.north_angle(p0));
	}
	/**
	...
	public  double distance3d(Point3D gps0, Point3D gps1) {
		...
		// Radiant distance between the x of the first coordinate and the x of the second coordinate
		double diffx_radian=diffy_radian(gps0.x(),gps1.x());	
		// Radiant distance between the y of the first coordinate and the y of the second coordinate
		double diffy_radian=diffy_radian(gps0.y(),gps1.y());
	...
	private double diffy_radian(double p0, double p1) {
		double diff=p1-p0;
